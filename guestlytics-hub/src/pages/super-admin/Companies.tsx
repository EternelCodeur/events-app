      ...
      <div className="flex flex-col md:flex-row gap-3">
        <div className="w-full md:w-auto">
          ...
          <input
            id="company-search"
            type="text"
            className="w-full md:w-64 h-9 px-3 py-1 border rounded-md bg-background text-sm"
        ...
        <div className="w-full md:w-auto">
          ...
          <select
            id="status-filter"
            className="h-9 px-3 py-1 border rounded-md bg-background text-sm w-full md:w-80"
            value={statusFilter}
